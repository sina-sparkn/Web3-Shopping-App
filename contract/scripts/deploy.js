...
async function main() {
  ...
  console.log(`contract address : ${rewardContract3.address}`);
  ...
  console.log(`contract address : ${rewardContract4.address}`);
  ...
  console.log(`contract address : ${rewardContract5.address}`);
}
