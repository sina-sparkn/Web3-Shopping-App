...
contract rewardFour is SoulBoundERC1155, Ownable {
    string name_;
    string symbol_;

    constructor()
        SoulBoundERC1155(
            "https://ipfs.io/ipfs/QmSamNbBXpUaxQAiQrx5RyCM8PiPTH1ozjxjvNL5UrSLmB/reward4meta.json"
        )
    {
        name_ = "REWARD-FOUR-MOONSHOP";
        symbol_ = "RFOUR";
